...
export default {
	head: () => ({
		...
		meta: [
			...
			{
				name: 'keywords',
				content: '싸방, 부동산 중개 플랫폼, 부동산, 매매, 시세, 부동산 시세, 분당구, 일산, 아이파크, e편한세상, 용산구, 마포동, 서교동 푸르지오'
			}
		],
	}),
}
